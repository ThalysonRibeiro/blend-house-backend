...
const CreateOrdeController_1 = require("./controllers/order/CreateOrdeController");
...
//order
router.post('/order', isAuthenticated_1.isAuthenticated, new CreateOrdeController_1.CreateOrdeController().handle);
